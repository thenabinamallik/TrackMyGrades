...
const testimonials = [
  {
    quote: "TrackMyGrad has transformed how I manage my academics. The intuitive dashboard helps me stay on top of assignments and track my progress effortlessly.",
    student: "Aisha Khan",
    branch: "Computer Science",
    year: "3rd Year",
  },
  {
    quote: "The attendance tracking and deadline reminders have been a lifesaver. I've never missed an assignment since I started using TrackMyGrad!",
    student: "Rahul Singh",
    branch: "Electrical Engineering",
    year: "2nd Year",
  },
  {
    quote: "As someone who struggled with organization, TrackMyGrad has been a game-changer for my academic life. Highly recommend to all students!",
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold">TrackMyGrad</span>
              </div>
        ...
        <section className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Get a glimpse of how TrackMyGrad can simplify your academic life.
              </p>
            </div>
          ...
          <div className="container mx-auto text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Join thousands of students who are already using TrackMyGrad to stay on top of their academic journey.
              </p>
        ...
        <footer className="border-t py-12 px-4 bg-muted/30">
          <div className="container mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground">© 2025 TrackMyGrad. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </AuthGuard>
