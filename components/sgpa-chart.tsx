...
const sgpaData = [
    { semester: 'Sem 1', sgpa: 6.7, target: 8.5, average: 7.8, year: '20233' },
    { semester: 'Sem 2', sgpa: 7.5, target: 8.5, average: 8.0, year: '2023' },
    { semester: 'Sem 3', sgpa: 8.0, target: 8.5, average: 8.1, year: '2023' },
    { semester: 'Sem 4', sgpa: 8.5, target: 8.5, average: 8.2, year: '2024' },
    { semester: 'Sem 5', sgpa: 8.5, target: 8.5, average: 8.3, year: '2024' },
    { semester: 'Sem 6', sgpa: 8.5, target: 8.5, average: 8.2, year: '2025' },
]
        ...
        <Card className="w-full">
            ...
            <CardContent>
                ...
                <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div className="text-center p-3 bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg">
